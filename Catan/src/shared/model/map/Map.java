...
public class Map {
	...
	//functions i wrotedsf
		...
		public boolean canBuildCity(int playerID, VertexLocation loc) {
			Piece tempPiece;
			try{
				tempPiece = verticies.get(loc.getNormalizedLocation()).getPiece();
	...
	public void randomizeHexes() {
		...
		int counter = 0;
		for (java.util.Map.Entry<HexLocation, TerrainHex> entry : hexes.entrySet()) {
	...
	public void randomizeNumbers() {
		...
		for(java.util.Map.Entry<HexLocation, TerrainHex> entry: getHexes().entrySet()){
